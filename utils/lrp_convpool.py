...
def LRP_ConvPool(args, train_dataset, test_dataset, num, data_type, model, model_folder, result_folder, name):
    ### Computation of lrp ###
    ...
    for i, batch in enumerate(test_loader):
        ...
        if i == args.batch:
            ...
            axs.set_xticklabels([''])
            fig.tight_layout()
            plt.savefig(os.path.join(result_folder,f'{name}_LRP_{args.pool}_{args.batch}_{args.sample}.pdf'))
            break