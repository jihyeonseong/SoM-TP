...
def train_SoMTP(args, train_dataset, valid_dataset, test_dataset, num, data_type, model, result_folder):
    ...
    for epoch in range(args.num_epoch):
        ...
        for batch in train_loader:
            ...
            x1, logits, ensem, one, op, attn = model(data)
            ...
            ce_loss = raw_loss + (ce(diverse, labels)+perspective_loss)* args.decay
            optim_h.zero_grad()
        ...
        with torch.no_grad():
            for batch in valid_loader:
                ...
                x1, logits, ensem, one, _, _ = model(data)
...
def _inference(args, model, ce, test_loader, epoch, valid_loss_list, valid_acc_list, result_folder, data_type, num):
    ...
    with torch.no_grad():
        ...
        for batch in test_loader:
            ...
            x1, logits, ensem, one, op2, attn2 = model(data)
